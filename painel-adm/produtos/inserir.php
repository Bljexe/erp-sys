...
if ($id == "") {
	...
	$res = $pdo->prepare("INSERT INTO produtos SET codigo = :codigo, nome = :nome, apresentacao = :apresentacao, fabricante = :fabricante, categoria = :categoria, custo = :custo, venda = :venda, lucro = :lucro ");
	...
	$res = $pdo->prepare("UPDATE produtos SET codigo = :codigo, nome = :nome, apresentacao = :apresentacao, fabricante = :fabricante, categoria = :categoria, custo = :custo, venda = :venda, lucro = :lucro WHERE id = :id ");
	$res->bindValue(":id", $id);
	$res->bindValue(":codigo", $codigo);
	$res->bindValue(":nome", $nome);
	$res->bindValue(":apresentacao", $apresentacao);
