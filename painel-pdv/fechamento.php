...
$res = $pdo->prepare("UPDATE caixa SET data_fec = curDate(), hora_fec = curTime(), valor_vendido = :valor_vendido, status = 'Fechado' WHERE operador = '$id_usuario' and status = 'Aberto'");
